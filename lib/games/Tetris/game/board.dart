...
class Board extends ChangeNotifier {
  ...
  Future<void> loadpop() async {
    try {
      final assetAudio = AudioSource.asset('assets/tetris/pop.mp3'); // Replace with your music file path in assets
  ...
  bool isBlockOut() {
    if (_blocked.where((e) => e.y == y - 1).isNotEmpty) {
      _isGameOver = true;
    }
    return _isGameOver;
  }
