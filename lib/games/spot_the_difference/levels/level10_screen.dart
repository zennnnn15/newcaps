...
class _GameScreen10State extends State<GameScreen10> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/lvl10/correct.png") {
      setState(() {
        score++;
      });
      CorrectImage();
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap("assets/spotthedif/lvl10/wrong.png");
                      } else {
                        WrongImage();
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl10/wrong.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap("assets/spotthedif/lvl10/correct.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl10/correct.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
