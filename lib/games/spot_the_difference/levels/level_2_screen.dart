...
class _GameScreen2State extends State<GameScreen2> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/lvl2/correct.png") {
      setState(() {
        score++;
      });
      CorrectImage();
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap("assets/lvl1/correct.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl2/correct.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap("assets/spotthedif/lvl2/wrong.png");
                      } else {
                        WrongImage();
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl2/wrong.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
