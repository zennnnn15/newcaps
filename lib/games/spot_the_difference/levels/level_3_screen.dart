import 'dart:async';
import 'package:capstone_focus/games/spot_the_difference/levels/level_2_screen.dart';
...
class _GameScreen3State extends State<GameScreen3> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/lvl3/correct.png") {
      setState(() {
        score++;
      });
      CorrectImage();
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap("assets/spotthedif/lvl3/wrong.png");
                      } else {
                        WrongImage();
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl3/wrong.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap("assets/spotthedif/lvl3/correct.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl3/correct.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
