              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap("assets/spotthedif/lvl5/wrong.png");
                      } else {
                        WrongImage();
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl5/wrong.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap("assets/spotthedif/lvl5/correct.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl5/correct.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
