              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap("assets/spotthedif/lvl6/wrong.png");
                      } else {
                        WrongImage();
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl6/wrong.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap("assets/spotthedif/lvl6/correct.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl6/correct.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
