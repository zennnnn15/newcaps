...
import 'level_7_screen.dart';
import 'level_9_screen.dart';
...
class _GameScreen8State extends State<GameScreen8> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/lvl8/correct.png") {
      setState(() {
        score++;
      });
      CorrectImage();
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap("assets/spotthedif/lvl8/wrong.png");
                      } else {
                        WrongImage();
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl8/wrong.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap("assets/spotthedif/lvl8/correct.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/lvl8/correct.png",
                      height: 100,
                      width: 100,
                    ),
                  ),
